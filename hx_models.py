...
AMP_MODELS: list[HXModel] = [
    ...
    HXModel(
        ...
        aliases     = ["Marshall Plexi", "Super Lead", "1959SLP",
                       "Hendrix", "Jimi Hendrix", "Led Zeppelin", "Jimmy Page", "Cream"],
    ),
    HXModel(
    ...
    HXModel(
        ...
        aliases     = ["Marshall JCM800", "JCM 800", "JMP", "2203", "2204",
                       "Zakk Wylde", "Ozzy", "classic metal", "NWOBHM"],
    ),
    HXModel(
    ...
    HXModel(
        ...
        default_params = {"Drive": 0.45, "Bass": 0.50, "Mid": 0.55, "Treble": 0.55,
                          ...
                          "Hum": 0.50, "Ripple": 0.50},
        paired_cab  = "HD2_CabMicIr_2x12BlueBell",
        aliases     = ["Dr. Z Z-Wreck", "Dr Z", "Z-Wreck", "Carol-Ann", "Carol Ann"],
    ),
    HXModel(
    ...
    HXModel(
        ...
        name        = "Hiway 100",
        category    = "Amp",
        description = "Hiwatt DR103. Clean, punchy British tone with massive headroom. Rock and prog.",
        ...
        aliases     = ["Hiwatt", "Hiwatt DR103", "DR103",
                       "David Gilmour", "Pink Floyd", "The Who", "Pete Townshend"],
    ),
    HXModel(
